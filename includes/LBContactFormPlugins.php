...
class ContactFormPROPlugins
{
	...
	public function getCustomFieldPlugins( ) {
		...
		$htm = "<span>  <select class='form_control_select' data-live-search='true' name = 'custom_fields' id ='custom_fields'  onchange='selectedcustomPRO( this  )'>";
		  $selected_option = "";
			...
			{	 
                                $selected_option .= "<option value='{$customslug}' > {$customlabel}  </option>";
			}
		  }
                $htm .= $selected_option;
                $htm .= "</select></span>";
	...
	public function getPluginActivationHtml( )
	{
		global $IncludedPluginsPRO;
                $html = '<span>  <select class="form_control_select" data-size="5"  data-live-search="true" name = "pluginselect" id ="pluginselect" onchange="selectedPlugPRO( this )">';
		$select_option = "";
