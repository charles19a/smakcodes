...
if(!class_exists("Vtiger_WSClient"))
{
	...
	class Vtiger_WSClient {
		...
		function __doChallenge($username) {
			...
			$servetime = isset($resultdata['result']['serverTime']) ? $resultdata['result']['serverTime'] : '';
			$exptime  = isset($resultdata['result']['expireTime']) ? $resultdata['result']['expireTime'] : '';
			$servetok = isset($resultdata['result']['token']) ? $resultdata['result']['token'] : '';
			$this->_servertime   = $servetime;
			$this->_expiretime   = $exptime;
			$this->_servicetoken = $servetok;
		...
		function doLogin($username, $vtigerUserAccesskey) {
			...
			$session = isset($resultdata['result']['sessionName']) ? $resultdata['result']['sessionName'] : '';
			$userid = isset($resultdata['result']['userId']) ? $resultdata['result']['userId'] : '';
		...
		function doQuery($query) {
			...
			$result = isset($resultdata['result']) ? $resultdata['result'] : '';
			return $result;	
