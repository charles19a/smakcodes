...
<div class='mt40'>
	<div class='panel' style="width:auto; margin-right: 20px;">
		<div class='panel-body'>
			...
			<form id="smack-<?php echo sanitize_text_field($active_plugin);?>-user-capture-settings-form" action=""
				method="post">
				<input type="hidden" name="smack-<?php echo  esc_attr($active_plugin);?>-user-capture-settings-form"
					value="smack-<?php echo  $active_plugin;?>-user-capture-settings-form" />
				...
				<div class='leads-builder-heading col-md-12'>
					<center>
						<h4 class="user_heading">
							<?php echo esc_html__("Capture WordPress users" , "wp-leads-builder-any-crm-pro" ); ?> 
						</h4>
					</center>
				</div>
				<div class='clearfix'></div>
				<div class='mt20'>
					...
					<div class="form-group col-md-12">
						<div class="col-md-4">
							<label id="innertext"
								class='leads-builder-label'><?php echo esc_html__( 'Select Plugin-Custom Fields ' , 'wp-leads-builder-any-crm-pro' ); ?></label>
						</div>
						<div class="col-md-3">
					...
					<div class="form-group col-md-12">
						...
						<div class="col-md-3">
							<select name="choose_module" id="choose_module" class='form_control_select'
								data-live-search='false' onchange="wpSyncSettingsPRO( this )">
								<option value="Leads" <?php
									if( isset( $config['user_sync_module']  ) && $config['user_sync_module'] == "Leads" && !empty($result['leadsynced']))
									{
								...
								<option value="Contacts" <?php
									if( (isset( $config['user_sync_module']  ) && $config['user_sync_module'] == "Contacts") || empty($result['leadsynced']))
									{
										echo "selected=selected";
									}
                        ...
                        ?>
							...
							<input type="button"
								value="<?php echo esc_attr__('Configure Mapping' , 'wp-leads-builder-any-crm-pro' );?>"
								class="config_mapping_button"
								onClick="window.location.href='<?php echo site_url()."/wp-admin/admin.php?page=lb-usermodulemapping"; ?>'" />
						</div>
					</div>
					...
					<div class="form-group col-md-12">
						<div class="col-md-4">
							<label id="innertext"
								class='leads-builder-label'><?php echo esc_html__("On Duplicate Data" , "wp-leads-builder-any-crm-pro" ); ?></label>
						</div>
						<div class="col-md-3">
							<select name="duplicate_handling" id="duplicate_handling" class='form_control_select'
					...
					<div>
						...
						<div class="form-group col-md-12">
							<div class="col-md-4">
								<label id="innertext"
									class='leads-builder-label'><?php echo esc_html__("WP User Auto Sync" , "wp-leads-builder-any-crm-pro" ); ?>
									<?php echo str_repeat( '&nbsp' , 13 );  ?></label>
							</div>
							<div class="col-md-3">
								<?php
								...
								<!-- tfa button -->
								<input id="enableAutoSync" type='checkbox'
									class="tgl tgl-skewed noicheck smack-vtiger-settings" name='enableAutoSync'
									<?php if( $check_sync_value == "On" ) { echo "checked"; }  ?>
									onclick="enableWPUserAutoSync(this.id)" />
								<label id="innertext" data-tg-off="OFF" data-tg-on="ON" for="enableAutoSync"
									class="tgl-btn enableAutoSync" style="font-size: 16px;">
								</label>
								<!-- tfa btn End -->
							</div>
							<div class='col-md-1'>
								<input type="button" id="OneTimeSync"
									...
									<?php if( $switch_sync_button == "On" ) { echo "disabled"; } ?>
									value="<?php echo esc_attr__('One Time Manual Sync ', 'wp-leads-builder-any-crm-pro' );?>"
									class="button-secondary submit-add-to-menu innersave"
									onclick="captureAlreadyRegisteredUsersPRO('<?php echo site_url(); ?>');" />
								</td>
							</div>
						</div>
...
switch( $activated_crm )
{
	...
	case 'wpzohopluspro':
		$html_leads = "";
		$html_leads = '<select class="form_control_select" name="usersync_assignedto_leads" id="usersync_assignedto_leads">';
	...
	case 'freshsales':
		...
		?>
						...
						<div class="form-group col-md-12">
							<div class="col-md-4">
								<div id='Lead_owner' style="width:250px;">
									<label id="innertext"
										class='leads-builder-label'><?php echo esc_html__("Lead Owner" , "wp-leads-builder-any-crm-pro" ); ?>
										<?php echo str_repeat( '&nbsp' , 26);  ?></label>
								</div>
								<div id='Contact_owner' style="width:250px;">
									<label id="innertext"
										class='leads-builder-label'><?php echo esc_html__("Contact Owner" , "wp-leads-builder-any-crm-pro" ); ?>
										<?php echo str_repeat( '&nbsp' , 20 );  ?></label>
								</div>
							</div>
							<div class="col-md-3">
								<?php echo $html_leads; ?>
						...
						<div class='col-md-12 '>
							<div class='col-md-1' id="note"><label id="inneroptions"
									class='leads-builder-heading'><h4><?php echo esc_html__("NOTE:" , "wp-leads-builder-any-crm-pro" ); ?></h4>
								</label>
							</div>
						</div>

						<div class="form-group col-md-12 notes ml7">
							<div class="col-md-3">
								<label id="innertext"
									class='leads-builder-label'><?php echo esc_html__("WP User Auto Sync" , "wp-leads-builder-any-crm-pro" ); ?></label>
								<span style="padding-left:9px;">: </span>
							</div>
							<div class="col-md-7">
								<label id="innertext" class='leads-builder-label'>Automatically sync WordPress users to
									CRM When Creating Or Updating Users</label>
							</div>
						</div>
						...
						<div class="form-group col-md-12 notes">
							<div class="col-md-3">
								<label id="innertext"
									class='leads-builder-label'><?php echo esc_html__("One Time Manual Sync " , "wp-leads-builder-any-crm-pro" ); ?>
									<span style="padding-left:9px;">: </span> </label>
							</div>
							<div class="col-md-7">
								<label id="innertext" class='leads-builder-label'> Sync existing Wordpress users as
									Leads or Contacts </label>
							</div>
						</div>
			...
			<div id="loading-image"
				style="display: none; background:url(<?php echo WP_PLUGIN_URL;?>/wp-leads-builder-any-crm-pro/assets/images/ajax-loaders.gif) no-repeat center">
